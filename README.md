...
[Jordan Wu](https://github.com/jordanwu97):  Manually annotating natural/ real images (images 001c.jpg to 901c.jpg, which can be accessed in [real.zip](https://github.com/tonyjoo974/mask-rcnn-using-synthetic-models/blob/master/data/real.zip) dataset), optimizing the employed Mask RCNN algorithm to be compatible with our dataset, and developing an algorithm that replaces CVAT image annotation tool using [flood_fill_helper.ipynb](https://github.com/tonyjoo974/mask-rcnn-using-synthetic-models/blob/master/src/flood_fill_helper.ipynb). 

[Hossein Kabir](https://github.com/91105206a): Manually annotating natural/real images (images 001d.jpg to 901d.jpg, which can be accessed in [real.zip](https://github.com/tonyjoo974/mask-rcnn-using-synthetic-models/blob/master/data/real.zip) dataset), creating [synthetic.zip](https://github.com/tonyjoo974/mask-rcnn-using-synthetic-models/blob/master/data/synthetic.zip) image dataset (images aSlide1.jpg to dSlide225.jpg), optimizing the employed Mask RCNN algorithm to be compatible with our dataset, and defining the “water” class [WaterDataset_with_its_utils.py](https://github.com/tonyjoo974/mask-rcnn-using-synthetic-models/blob/master/src/WaterDataset_with_its_utils.py) for detecting and labelling the water level. 
...
[1] [He, K., Gkioxari, G., Dollár, P., & Girshick, R. (2017). Mask r-cnn. In Proceedings of the IEEE international conference on computer vision (pp. 2961-2969)] (https://openaccess.thecvf.com/content_ICCV_2017/papers/He_Mask_R-CNN_ICCV_2017_paper.pdf) 
